...
/**
 * The {@link DehydrationAPI} interface, when implemented, allows you to access the main functions provided by the API.
 * <br>
...
public interface DehydrationAPI {
    ...
    /**
     * Calculates the thirst that you get from a specific {@link DrinkItem}.
     * <br>
     * The usual approach for implementing this method would be by using Minecraft tags, like in {@link CroptopiaCompat}.
     * <br>
