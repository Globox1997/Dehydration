...
public class ThirstManager implements DamageSourceAccessor {
  ...
  //   this.thirstDehydrationLevel = Math.min(this.thirstDehydrationLevel + (float) food * f * 2.0F,
  ...
  //       this.thirstDehydrationLevel = Math.max(this.thirstDehydrationLevel - 1.0F, 0.0F);
  ...
  //   if (bl && this.thirstDehydrationLevel > 0.0F && player.canFoodHeal() && this.thirstLevel >= 20) {
